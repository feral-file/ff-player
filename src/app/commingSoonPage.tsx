const ComingSoonPage = ({screenRatio} : {screenRatio: number}) => {
    return (
        <div style={{position: 'absolute', top: 0, zIndex: 2, backgroundColor: 'rgba(0, 0, 0, 0.80)', width: '100vw', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0 30%'}}>
