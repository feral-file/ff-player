...
// --- Pure exports (no component harness) ---
...
// --- PlaylistClient: final-slot hold, queue promotion, playlistKey ---

/* eslint-disable-next-line max-lines-per-function -- grouped nested describes; bodies unchanged */
describe('PlaylistClient — hold queue, deferred refresh, and playlistKey', () => {
  beforeEach(() => {
    vi.useFakeTimers();
  });
  ...
  describe('no hold (final item has no finite slot timer)', () => {
  ...
  describe('hold completed final timed slot', () => {
  ...
  describe('playlistKey refresh on playlist replacement', () => {
...
// --- PlaylistClient: intermission overlays, dismissals, queued promotions ---

/* eslint-disable-next-line max-lines-per-function -- grouped nested describes; bodies unchanged */
describe('PlaylistClient — intermission overlays and queued promotions', () => {
  beforeEach(() => {
    vi.useFakeTimers();
  });
  ...
  describe('queued refresh after intro timer completes', () => {
  ...
  describe('queued refresh after intro dismiss', () => {
  ...
  describe('queued shuffle after playlist intro dismiss', () => {
  ...
  describe('currentItemRef regression', () => {
  ...
  describe('keepCurrent on shuffle dismiss', () => {
  ...
  describe('same first item after queued refresh', () => {
  ...
  describe('keepCurrent when id missing from queue', () => {
  ...
  describe('dismiss with no queued update', () => {
  ...
  describe('playlist intro at boot', () => {
  ...
  describe('setLoop during intermission', () => {
...
// --- PlaylistClient: playlist identity, playlistKey churn, cross-playlist ---

/* eslint-disable-next-line max-lines-per-function -- grouped nested describes; bodies unchanged */
describe('PlaylistClient — playlist identity and cross-playlist', () => {
  beforeEach(() => {
    vi.useFakeTimers();
  });
  ...
  describe('playlistKey flip cuts short stale overlay', () => {
  ...
  describe('queued cross-playlist promotion during intro', () => {
  ...
  describe('deferred refresh + cross-playlist dismiss flush', () => {
...
// --- PlaylistClient: moveToArtwork ---

/* eslint-disable-next-line max-lines-per-function -- grouped nested describes; bodies unchanged */
describe('PlaylistClient — moveToArtwork', () => {
  beforeEach(() => {
    vi.useFakeTimers();
  });
  ...
  describe('always shows destination intro', () => {
  ...
  describe('bypasses playlist intro', () => {
  ...
  describe('bypasses playlist intro with queued pending', () => {
...
// --- PlaylistClient: loop mode and republish ---

/* eslint-disable-next-line max-lines-per-function -- grouped nested describes; bodies unchanged */
describe('PlaylistClient — loop mode and republish', () => {
  beforeEach(() => {
    vi.useFakeTimers();
  });
  ...
  describe('updateIndex does not replay intros on loop', () => {
  ...
  describe('loop-playlist wrap replays item intro', () => {
  ...
  describe('loop-playlist wrap replays playlist welcome', () => {
  ...
  describe('same-id displayPlaylist preserves dismissal', () => {
